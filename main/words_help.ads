...
private
   ...
   FREQ_HELP : constant Main_Help_Type :=
     (Underline_Next,
      ...
      "Very rare    no more than a couple unusual and strange example(s)|             ",
      "Inscription  only citation located thus far is an inscription|                 ",
      Skip_Next,
      "  ***No scholarly rigor is assured.  This dictionary is an amateur project***| ");
   ...
   SOURCE_HELP : constant Main_Help_Type :=
     (Underline_Next,
      "SOURCE CODES|                                                                  ",
      Skip_Next,
      "CAVEAT: The one-character source code is a very rough, highly imperfect guide| ",
      "  to the confidence you might have in an entry. Most entries were checked|     ",
      "  against multiple sources. The code ideally indicates the most useful,|       ",
      "  comprehensive, or authoritative of those sources. Note that those criteria|  ",
      "  are subjective, may conflict, and may be weighted for nonobvious reasons.|   ",
      "  E.g., L+S may be be favored over the OLD if a word developed significant new|",
      "  meanings after the classical period. Sometimes codes are arbitrary; often|   ",
      "  they just indicate the first work Whitaker consulted.|                       ",
      Skip_Next, Bold_Next,
      ...
      "         OR Cassells New Compact, 1963 (NC Cas) (reprinted under various names)",
      ...
      "W       Col. Whitaker's personal guess, mostly obvious extrapolation|          ",
      "Y       Col. Whitaker's undefined 'temporary' special code|                    ",
      "Z       Sent by user--no dictionary reference|                                 ",
      Skip_Next,
      "A source that provides uncertain, conflicting, or substantially unique meanings",
      ...
      Bold_Next,
      "*In-copyright works used for fact reference; protected expression NEVER copied.",
      Skip_Next,
