...
GRAMMAR_HELP : constant MAIN_HELP_TYPE :=  (
  ...
  "M is the GENDER (M, F, N, C : masc., fem. neuter, common m/f form               ",
  "                                                                                ",
...
FREQ_HELP : constant MAIN_HELP_TYPE :=  (
  ...
  "N    Pliny            appears (almost) only in Plinys Natural History           ",
  "                                                                                ",
...
MEANING_HELP : constant MAIN_HELP_TYPE :=  (
  ...
  "      to indicate that the characters are low or crude. Meanings given by t     ",
  "      he program for these words are more polite, and the user is invited to    ",
